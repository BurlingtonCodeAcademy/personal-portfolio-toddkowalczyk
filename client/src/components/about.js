    ...
    return (
        <div>
            ...
            <ul class="who-items">
                ...
                <li>I am fascinated with sofware development.  It never gets old because we keep building new, cooler stuff!</li>
                <li>Spent the first 18 years of my career as a Developer, the first few years mainframe COBOL</li>
